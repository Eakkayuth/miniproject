...
import 'package:miniproject/utils/env.dart';
...
class CallApi {
  ...
  static Future<List<User>> inserNewUserAPI(User user) async {
    ...
    final responseData = await http.post(
      Uri.parse(
          '${Env.baseUrl}/moneytrackingservice/apis/insert_new_user_api.php'),
  ...
  static Future<List<Money>> callMoneybyUserIdAPI(String userId) async {
    final responseData = await http.post(
      Uri.parse(
          '${Env.baseUrl}/moneytrackingservice/apis/call_money_by_userid_api.php'),
      headers: {'Content-Type': 'application/json'},
  ...
  static Future<List<Money>> insertMoneyInOutAPI(Money money) async {
    final responseData = await http.post(
      Uri.parse(
          "${Env.baseUrl}/moneytrackingservice/apis/insert_money_in_out_api.php"),
