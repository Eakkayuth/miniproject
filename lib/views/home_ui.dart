...
import 'package:miniproject/views/money_in_and_out_ui.dart';
import 'package:miniproject/views/money_in_ui.dart';
import 'package:miniproject/views/money_out_ui.dart';
...
class _HomeUiState extends State<HomeUi> {
  ...
  late List _currentShow = [
    ...
    MoneyInAndOutUi(user: widget.user),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar: BottomNavigationBar(
        ...
        backgroundColor: Color.fromARGB(255, 80, 152, 152),
      ),
      body: _isLoading
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: Color.fromARGB(255, 5, 131, 118),
